...
section('4. カタログ（氷術師）: active5/passive/進化3・不整合0');
{
  ...
  ok(cat.summary.activeCount === 30, `氷術師 active30種 (${cat.summary.activeCount})`); // M7-B 5→15・M7-C 15→25・M7-D 25→30
  ok(cat.summary.evolutionCount === 18, `氷術師 進化18種 (${cat.summary.evolutionCount})`); // M7-B 3→8・M7-C 8→13・M7-D 13→18

...
section('4. カタログ（氷術師）: active5/passive/進化3・不整合0');
{
  ...
  ok(cat.summary.activeCount === 25, `氷術師 active25種 (${cat.summary.activeCount})`); // M7-B で 5→15・M7-C で 15→25
  ok(cat.summary.evolutionCount === 13, `氷術師 進化13種 (${cat.summary.evolutionCount})`); // M7-B で 3→8・M7-C で 8→13
